            ...
            <main>
                  <center>
                        <div class="regdiv" id="regdiv">
                              <form id="form" action="reg.inc.php" method="POST" autocomplete="on">
                                    <div id="header">
                                          <div>
                                    ...
                                    <div id="indiv">
                                          ...
                                          <input class="input" type="text" name="username" value="" autofocus maxlength="50"><br>
                                          ...
                                          <select class="input" name="ideology">
                                                <option value="National Socialist">National Socialist</option>
                                                <option value="Fascist">Fascist</option>
                                                <option value="Conservative">Conservative</option>
                                                <option value="Communist">Communist</option>
                                                <option value="Falangist">Falangist</option>
                                                <option value="Nationalist">Nationalist</option>
                                                <option value="Hungarist">Hungarist</option>
                                                <option value="Legionary">Legionary</option>
                                                <option value="Anti-Communist">Anti-Communist</option>
                                                <option value="Populist">Populist</option>
                                                <option value="Anti-Feminist">Anti-Feminist</option>
                                                <option value="Neo-Nationalist">Neo-Nationalist</option>
                                                <option value="Monarchist">Monarchist</option>
                                                <option value="Autocrat">Autocrat</option>
                                                <option value="Centralist">Centralist</option>
                                                <option value="National Conservative">National Conservative</option>
                                                <option value="Jingoist">Jingoist</option>
                                                <option value="Patriot">Patriot</option>
                                                <option value="Environmentalist">Environmentalist</option>
                                                <option value="Eco-fascist">Eco-Fascist</option>
                                                <option value="Eco-nationalist">Eco-nationalist</option>
                                                <option value="Irredentist">Irredentist</option>
                                                <option value="White Supremacist">White Supremacist</option>
                                                <option value="Imperialism">Imperialist</option>
                                                <option value="Turanist">Turanist</option>
                                          </select>
                                          <br>
                                          ...
                                          <select class="input" name="religion">
                                                ...
                                                <option value="Paganism">Buddhist</option>
                                                <option value="Paganism">Norse pagan</option>
                                                <option value="Hinduist">Hinduist</option>
                                                <option value="Muslim">Muslim</option>
                                                <option value="Judaist">Judaist</option>
                                                <option value="Judaist">Tengrist</option>
                                                <option value="Shintoist">Shintoist</option>
                                          </select>
                                          <br>
                                          <label>Date of birth</label>
                                          <br>
                                          <input class="input" type="date" name="born" value="">
                                          <br>
                                          <label>Sex</label>
                                          <div id="sexlabeldiv">
                                              <label id="lmalesex">Male</label>
                                              <label  id="lfemalesex">Female</label>
                                          </div>
                                          <div id="sexdiv">
                                              <input id="malesex" type="radio" name="sex" value="Male">
                                              <input id="femalesex" type="radio" name="sex" value="Female">
                                          </div>
