...
<html lang="en">
      ...
      <body
          ...
          <?php
          if (isset($_SESSION['usertab1']) && !isset($_SESSION['usertab2'])){
              echo "onload='tab1ref()'";
          }
          elseif (isset($_SESSION['usertab2']) && !isset($_SESSION['usertab1'])){
              echo "onload='tab2ref()'";
          }
          elseif (isset($_SESSION['usertab1']) && isset($_SESSION['usertab2'])){
              echo "onload='tab12ref()'";
          }
          ?>
      >
