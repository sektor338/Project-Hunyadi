...
<main>
    <center>
        <div id="main">
            ...
            <form action="pwdreset.inc.php" method="post">
                <label for="emailinput">Email</label><br>
                <input id="emailinput" type="email" required name="email"><br>
                <button id="pwdresetbtn" type="submit" name="request">Request password reset</button>
            </form>
        </div>
    </center>
</main>
