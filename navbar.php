<nav id="headernav">
    <ul id="headerul"
        ...
        {
            echo 'onmouseover="dropdown()" onmouseout="navup()"';
        }
        ?>
    >
        <li class="dropdownclass" id="dropdown"><img id="dropdownimg" src="pictures/icons/dropdown1.png" alt="dropdown1"></li>
...
<li class="navbarli"><a href="upload.php" value="upload" class="navbara" id="upload">Upload</a></li>
                  <li style="padding:0; vertical-align:sub;" class="navbarli"><form action="logout.inc.php" method="post">
                        <button style="padding:0; cursor: pointer; vertical-align:sub;" type="submit" id="logout" name="logout"><img style="width: 30px; height: 30px; padding:0; margin:0;" src="pictures/icons/logout.png" alt="logout"></button>
                  </form></li>
                  <li style="padding:0;" class="navbarli settingsnav"><a class="navbara" href="/settings.php" style="padding:0; cursor: pointer; "><img style="width: 30px; height: 30px; padding:0; margin:0; " src="pictures/icons/settings.png" alt="settings"></a></li>
                  ';
