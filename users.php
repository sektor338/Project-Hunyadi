...
<main>
    ...
    if (isset($_GET['user'])) {
        ...
        if ($_SESSION['username'] != $user['name']) {
            if ($friendsql[0] == 0 && $friendsql['status'] != "blocked") {
                ...
                if ($friendsql['status'] == "accepted") {
                    echo "<img title='Remove from friends' id='friendaction' class='friendbtns' src='pictures/icons/deletef.png' name='" . $friendsql['friendrid'] . "' onclick='fudeny()' alt='deletefriend'>";
                    echo "<img title='Block' id='friendaction' class='friendbtns' src='pictures/icons/block.png' name='" . $friendsql['friendrid'] . "' onclick='fublock()' alt='block'>";
                }
            }
        }
    }
        ...
        if ($user['patreon'] !== 'pictures/ranks and insignia/Sleeve(parka)/trans.png') {
                            ...
                            echo "               <img id='reward' src='" . $user['patreon'] . "' alt='Patreon'>";
                                            

        }
        echo "<img id='reward' src='pictures/rewards/ss1year.png' alt='Service'>";
